...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-10 pt-20 md:pt-0 md:min-h-screen gap-4 text-center md:text-left bg-gradient-to-b from-primary to-secondary">
      <div className="flex flex-col gap-2 lg:gap-2 z-10 justify-center items-center w-full md:w-2/3 max-w-4xl">
        ...
        <div className="flex flex-col items-center justify-center gap-6 relative">
          <div className="flex items-center justify-center w-full relative">
            ...
            <div className="w-1/3 hidden md:block relative">
              <div className="flex flex-col absolute inset-0 bg-gradient-to-l from-transparent to-black/20 z-20" />
              <div className="relative z-10">
                <SkillSlider direction="right" speed={20} />
              </div>
              <div className="relative z-10">
