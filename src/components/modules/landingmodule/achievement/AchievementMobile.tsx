...
const AchievementMobile = () => {
  ...
  return (
    <div
      id="achievements"
      className="flex flex-col min-h-screen items-center justify-center gap-6 z-10 py-20 md:py-40 px-6 md:px-30"
    >
      <motion.div
      ...
      <div className="flex flex-col md:flex-row gap-2 z-10 py-2 justify-center items-center">
        ...
        <div className="flex flex-wrap gap-2 justify-center md:flex-row">
          ...
          <Chips
            ...
            text={width > 768 ? 'Elementary' : 'Elem'}
            color="#9BF6FF"
          />
        </div>
      ...
      >
        {displayedProjects.map((project, index) => (
          <Card variant={5} key={index} props={project} />
        ))}
      </motion.div>
